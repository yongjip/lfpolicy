...
Then publish by publishing a GitHub Release for a version tag such as `v0.8.2`,
or by manually dispatching the release workflow with `release_tag: v0.8.2`.
...
gh release create v0.8.2 --title "lfguard 0.8.2" --notes-file docs/release-notes/v0.8.2.md
```
...
git ls-remote --tags origin v0.8.2
```
