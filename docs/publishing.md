...
Then publish by publishing a GitHub Release for a version tag such as `v0.11.0`,
or by manually dispatching the release workflow with `release_tag: v0.11.0`.
...
gh release create v0.11.0 --title "lfpolicy 0.11.0" --notes-file docs/release-notes/v0.11.0.md
```
