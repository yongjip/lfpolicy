...
Then publish by publishing a GitHub Release for a version tag such as `v0.9.1`,
or by manually dispatching the release workflow with `release_tag: v0.9.1`.
...
gh release create v0.9.1 --title "lfguard 0.9.1" --notes-file docs/release-notes/v0.9.1.md
```
